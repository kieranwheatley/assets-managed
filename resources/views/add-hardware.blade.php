...
@section('content')
    <div class="container">
        <form action="{{ url('hardware/add')}}" method="POST">
            {{ csrf_field() }}
            @method('POST')
            <br>
            <div class="row">
                ...
                <div class="col">
                    <x-adminlte-input name="model" label="Model" fgroup-class="col-md-9"
                        disable-feedback />
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <x-adminlte-input name="serial_number" label="Serial Number"
                ...
                <div class="col">
                    ...
                    @php
                        $config = ['format' => 'L'];
                    @endphp
                    <x-adminlte-input-date name="idDateOnly" :config="$config" placeholder="Choose a date..." label="Purchase Date" fgroup-class="col-md-9" input name="purchase_date">
            ...
            <div class="row">
                <div class="col">
                    <x-adminlte-input name="warranty_date" label="Warranty Expiry Date"
                        fgroup-class="col-md-9" />
                </div>
                <div class="col">
